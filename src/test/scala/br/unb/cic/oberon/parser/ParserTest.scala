  ...
  test(testName = "Testing the module GeneralArrayInitializationAssignment"){
    ...
    test(testName = "Testing the module ArrayInitialization"){
       ...
       module.stmt.get match {
        ...
        assert(arrayInitializationStmt.designator.asInstanceOf[ArrayAssignmentEmpty].array.asInstanceOf[VarExpression].name == "temperatureRecords")
        ...
        assert(arrayInitializationStmt2.designator.asInstanceOf[ArrayAssignmentEmpty].array.asInstanceOf[FieldAccessExpression].exp.asInstanceOf[VarExpression].name
               + "." +
               arrayInitializationStmt2.designator.asInstanceOf[ArrayAssignmentEmpty].array.asInstanceOf[FieldAccessExpression].name
               == "calculusGrades.studentsNames")

        // Testing subarray initialization.
        assert(stmts(3).isInstanceOf[AssignmentStmt])
        val arrayInitializationStmt3 = stmts(3).asInstanceOf[AssignmentStmt]
        assert(arrayInitializationStmt3.exp.asInstanceOf[ArrayList].arrayList(0).asInstanceOf[Value].value == 3.4000000953674316)
        assert(arrayInitializationStmt3.designator.asInstanceOf[ArrayAssignmentEmpty].array.asInstanceOf[ArraySubscript].arrayBase.asInstanceOf[FieldAccessExpression].exp.asInstanceOf[VarExpression].name
               + "." +
               arrayInitializationStmt3.designator.asInstanceOf[ArrayAssignmentEmpty].array.asInstanceOf[ArraySubscript].arrayBase.asInstanceOf[FieldAccessExpression].name
               + '[' +
               arrayInitializationStmt3.designator.asInstanceOf[ArrayAssignmentEmpty].array.asInstanceOf[ArraySubscript].index.asInstanceOf[Value].value
               + ']'
               == "calculusGrades.studentsGrades[1]")
        ...
        == "2.0 + sum")
        assert(arrayInitializationStmt5.designator.asInstanceOf[ArrayAssignmentEmpty].array.asInstanceOf[ArraySubscript].arrayBase.asInstanceOf[FieldAccessExpression].exp.asInstanceOf[VarExpression].name
               + "." +
               arrayInitializationStmt5.designator.asInstanceOf[ArrayAssignmentEmpty].array.asInstanceOf[ArraySubscript].arrayBase.asInstanceOf[FieldAccessExpression].name
               + '[' +
               arrayInitializationStmt5.designator.asInstanceOf[ArrayAssignmentEmpty].array.asInstanceOf[ArraySubscript].index.asInstanceOf[Value].value
               + ']'
